                ...
                <div className="qualification__sections">
                    ...
                    <div className={
                        ...
                        <div className="qualification__data">
                            <div>
                                <h3 className="qualification__title">B.E <br />CSE(DS/AI)</h3>
                        ...
                        <div className="qualification__data">
                            ...
                            <div>
                                <h3 className="qualification__title">Diploma <br />Polytechnic</h3>
                                <span className="qualification__subtitle">Manuu University</span>
                                <div className="qualification__calendar">
